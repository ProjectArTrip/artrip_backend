...
public enum FavoriteErrorCode implements BaseErrorCode {
    ...
    _ALREADY_FAVORITED(HttpStatus.CONFLICT, "FAVORITE409-CONFLICT", "이미 즐겨찾기에 추가된 전시입니다."),
    _FAVORITE_NOT_FOUND(HttpStatus.NOT_FOUND, "FAVORITE404-NOT_FOUND", "즐겨찾기 항목을 찾을 수 없습니다."),
    _ALREADY_CANCELED(HttpStatus.CONFLICT, "FAVORITE409-CONFLICT",  "이미 처리된 즐겨찾기 입니다.");
